...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/aviator-coding/bchd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/aviator-coding/bchd/blockchain/fullblocktests
```
