...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Aviator-Coding/bchd/connmgr)
...
```bash
$ go get -u github.com/Aviator-Coding/bchd/connmgr
```
